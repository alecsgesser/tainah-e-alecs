    ...
    <Box id="rsvp" sx={{
      ...
      <Box sx={{ position: 'relative', zIndex: 1, maxWidth: 700, mx: 'auto', px: { xs: 2, md: 4 } }}>
        <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
          ...
          <Typography variant="h2" sx={{ color: '#fff', fontSize: { xs: '2.5rem', md: '4rem' }, fontStyle: 'italic', mb: 2 }}>
            RSVP
          </Typography>
          <Typography sx={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.85rem', fontWeight: 300 }}>
        ...
        {submitted ? (
          <Box sx={{ textAlign: 'center', py: 8 }}>
            <CheckCircleOutlineIcon sx={{ color: '#c9a96e', fontSize: 64, mb: 3 }} />
            <Typography variant="h4" sx={{ color: '#fff', fontStyle: 'italic', mb: 2 }}>
              Obrigado, {form.name}!
            </Typography>
